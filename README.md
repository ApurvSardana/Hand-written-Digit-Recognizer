...
* 📊 [Dataset](#-dataset)  
* 🏗️ [Model Architecture](https://github.com/ApurvSardana/Hand-written-Digit-Recognizer?tab=readme-ov-file#-model-architecture)  
* 🔄 [Training Process](#-training-process)  
* 📈 [Results](#-results)  
* ⚙️ [Setup and Usage](https://github.com/ApurvSardana/Hand-written-Digit-Recognizer?tab=readme-ov-file#-setup-and-usage)  
